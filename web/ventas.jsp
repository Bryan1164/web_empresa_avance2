<%-- 
    Document   : ventas
    Created on : 14/10/2020, 11:37:12
    Author     : i14i34500w10
--%>
...
<html>
    ...
    <body>
     ...
     <div class="container">                        
        <br><h3 style="text-align: center;" class="text-danger">Lista de ventas</h3><br>
                    ...
                    <div class="modal-content">
                        <form action="sr_ventas" method="post" class="form-group" >
                            ...
                            <div class="modal-body">
                                ...
                                <input type="number" id="txt_id_cliente" name="txt_id_cliente" class="form-control" value="0" readonly>
        ...
        <!-- Fin de formulario: Modificar venta -->
    ...
    <script>
            ...
            $('#tbl_ventas').on('click','tr td', function(evt){
               var target,id_venta,id_cliente,no_factura,no_serie,fecha_factura,nombres,apellidos,nit,genero,telefono,correo_electronico,fecha_ingreso;
               ...
               no_factura = target.parents("tr").find("td").eq(2).html();
               no_serie = target.parents("tr").find("td").eq(3).html();
               fecha_factura = target.parents("tr").find("td").eq(4).html();
               nombres = target.parents("tr").find("td").eq(5).html();
               apellidos = target.parents("tr").find("td").eq(6).html();
               nit = target.parents("tr").find("td").eq(7).html();
               genero = target.parents("tr").find("td").eq(8).html();
               telefono = target.parents("tr").find("td").eq(9).html();
               correo_electronico = target.parents("tr").find("td").eq(10).html();
               fecha_ingreso = target.parents("tr").find("td").eq(11).html();
